...
<div class="footer" id="hosted">
  ...
  <h3 v-if="isAvailable">
  Start using iMessage on Android today! <br>No Apple device required.
  <div style="font-size: 17px; margin-top: 5px;">Available right now; capacity is limited.</div>
  </h3>
...
There is a $16.99 USD monthly fee for OpenBubbles Hosted with a $1.00 7-day trial. <br> <a href="/quickstart.html">Self-host without your Android number for free.</a>
